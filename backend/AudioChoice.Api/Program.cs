...
// calls /v1/purchases/google again (or /v1/account/access, refreshed by PurchaseViewModel and
// PurchaseManager) and this server re-derives the correct expiry from Google directly.
