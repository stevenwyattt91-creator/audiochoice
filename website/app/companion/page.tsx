...
const steps = [
  ["01", "Choose your audiobook", "Select an M4B, M4A, MP3, or AAX file from your computer."],
...
export default function CompanionPage() {
  ...
  return (
    <main className="companion-page transfer-page">
      <nav className="nav shell" aria-label="Transfer navigation"><a className="brand" href="/" aria-label="AudioChoice home"><img src="/audiochoice-logo.png" alt="" /><span>Audio<span>Choice</span></span></a><div className="companion-nav-actions"><Link href="/#download">Download</Link><button className="nav-signin" type="button" onClick={() => setShowSignIn(true)}>{signedIn ? `Signed in${accountEmail ? ` · ${accountEmail}` : ""}` : "Sign in"}</button><a className="companion-back" href="/">← Back to AudioChoice</a></div></nav>
