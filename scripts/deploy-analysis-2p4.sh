...
az deployment group create --name audiochoice-staging-analysis-2p4-api \
...
az deployment group create --name audiochoice-staging-analysis-2p4-worker \
...
echo
echo 'Analysis 2.4 sustained-scene precision deployment completed.'
