...
az deployment group create --name audiochoice-staging-analysis-2p5-api \
...
az deployment group create --name audiochoice-staging-analysis-2p5-worker \
...
echo
echo 'Analysis 2.5 isolated scene verification deployment completed.'
