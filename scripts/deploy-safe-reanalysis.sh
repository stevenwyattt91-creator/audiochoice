...
az deployment group create \
  --name audiochoice-staging-safe-reanalysis-api \
  --resource-group "$resource_group" \
...
az deployment group create \
  --name audiochoice-staging-safe-reanalysis-worker \
  --resource-group "$resource_group" \
...
echo
echo 'Safe saved-transcript reanalysis deployment completed.'
