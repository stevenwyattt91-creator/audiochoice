...
az deployment group create --name audiochoice-staging-analysis-2p3-api \
...
az deployment group create --name audiochoice-staging-analysis-2p3-worker \
...
echo
echo 'Analysis 2.3 high-precision scene verification deployment completed.'
